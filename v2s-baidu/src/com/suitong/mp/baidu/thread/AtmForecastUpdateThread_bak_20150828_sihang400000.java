 ...
 *
 */
public class AtmForecastUpdateThread_bak_20150828_sihang400000 implements Runnable {
	...
	public AtmForecastUpdateThread_bak_20150828_sihang400000(int pageNo, int pageSize){
		...
		if(originList!=null && originList.size() > 0){
			try {
				...
				if(continueTime == maxContinueTime){
					...
					//再重启定时器任务
					AtmForecastTimer timerTask = new AtmForecastTimer( new AtmForecastUpdateThread_bak_20150828_sihang400000(this.pageNo, this.pageSize) );
