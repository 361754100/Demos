...
public class AtmForecastUpdatePartThread implements Runnable {
	...
	public AtmForecastUpdatePartThread(){
...
//		this.maxContinueTime = this.maxTryNum;
	...
	public void run() {
		tryNum = 5;
		if( taskManager.isUpdatePartRunning() ){
		...
		taskManager.setUpdatePartRunning(true);
		try {
	...
	public void getAtmForecastInfoFromBaidu( Map<String,String> queryParams ) throws Exception{
		...
		List<Map<String,Object>> origins = atmInfoService.queryUnExistForcastItems(queryParams);
		...
		for(int i = 0; i< originSize ; i++){
			...
			destinations = atmInfoService.requireSql(queryParams);
