 ...
 *
 */
public class AtmForecastUpdateThread_bak20150827 implements Runnable {
	...
	public AtmForecastUpdateThread_bak20150827(int pageNo, int pageSize){
		...
		if(originList!=null && originList.size() > 0){
			try {
				...
				if(continueTime == maxContinueTime){
					...
					//再重启定时器任务
					AtmForecastTimer timerTask = new AtmForecastTimer( new AtmForecastUpdateThread_bak20150827(this.pageNo, this.pageSize) );
