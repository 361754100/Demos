...
import com.suntek.jedis.utils.JedisUtils;

public class JedisClientDemo {
	private static final String ip = "127.0.0.1";
	private static final int port = 6379;
	public static void main(String[] args){
//		JedisUtils.getPool().destroy();
		JedisClientDemo demo = new JedisClientDemo();
		demo.HelloJedis();
	}
	
	public void HelloJedis(){
		Jedis jedis = JedisUtils.getInstance().getJedis(ip, port);
		
		System.out.println("jedis --->"+jedis);
		
		jedis.set("JedisClientDemo", "This is JedisClientDemo that show us how to use Redis Server!");
		
		System.out.println(jedis.get("JedisClientDemo"));
		try {
		...
		jedis.append("JedisClientDemo"," new appended value ");
		System.out.println(jedis.get("JedisClientDemo"));
	}
    ...
    public static void testString() {  
        ...
        try {  
        	...
        	JedisUtils.getInstance().getPool(ip,port).returnResource(jedis);  
        }  
    ...
    public void testSort1() {  
        ...
        Jedis redis = JedisUtils.getInstance().getJedis(ip,port);  
        ...
        redis.flushDB();  
        JedisUtils.getInstance().closeJedis(redis,ip,port);  
    }  
